/**
 * PrayerJournalPage.jsx  —  /prayer-journal
 * Full prayer journal page with requests, answers, and categories.
 */

import { motion } from 'framer-motion'
import Navbar from '../components/Navbar'
import Footer from '../components/Footer'
import PrayerJournal from '../components/Journal/PrayerJournal'
      ...
      <header style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '640px', margin: '0 auto' }}>
          ...
          >
            ...
            <br />
            <span style={{ fontSize: '0.85em', opacity: 0.7 }}>— Philippians 4:6</span>
          </motion.p>
        </div>
      </header>
